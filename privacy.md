...
## What Kite stores, and where

Everything you enter — your pay schedule, bills, expenses, debts and payment
history — is stored in a database file on your device, inside Kite's own app
container. It is not uploaded anywhere, because there is nowhere to upload it
to: Kite has no backend.
...
share sheet. Where it goes from there is your choice — Files or Drive, iCloud,
AirDrop or Nearby Share, email.
...
- **Unlocking** — Face ID or Touch ID on iPhone, fingerprint, face or screen
  lock on Android, used only to unlock the app on your device. The result is a
...
Kite is not directed at children and collects no information from anyone.

## Changes

If a future version ever collects anything, this policy will be updated before
that version ships, and the change will be described in the release notes.
